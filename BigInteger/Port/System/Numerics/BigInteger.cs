          ...
          ISignedNumber<BigInteger>
    {
        ...
        public bool IsPowerOfTwo
        {
            get
            {
                ...
                return BitOperations.IsPow2(_bits[iu]) && _bits.AsSpan(0, iu).IndexOfAnyExcept(0u) < 0;
            }
        }
        ...
        {
            return Number.TryParseBigInteger(value, style, NumberFormatInfo.GetInstance(provider), out result) == ParsingStatus.OK;
        }
        ...
        public static BigInteger operator >>(BigInteger value, int shift)
        {
            ...
            if (neg && (carry != 0 || bits.Slice(0, digitShift).IndexOfAnyExcept(0u) >= 0))
            {
