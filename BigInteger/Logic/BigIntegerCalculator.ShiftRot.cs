    ...
    static partial class BigIntegerCalculator
    {
        ...
        public static void LeftShiftSelf(Span<uint> bits, int shift, out uint carry)
        {
            ...
            if (Vector128.IsHardwareAccelerated)
            {
                ...
                {
                    Vector256<uint> current = Vector256.ShiftLeft(Vector256.LoadUnsafe(ref start, (nuint)(offset - Vector256<uint>.Count)), shift);
                    Vector256<uint> carries = Vector256.ShiftRightLogical(Vector256.LoadUnsafe(ref start, (nuint)(offset - (Vector256<uint>.Count + 1))), back);
                ...
                {
                    Vector128<uint> current = Vector128.ShiftLeft(Vector128.LoadUnsafe(ref start, (nuint)(offset - Vector128<uint>.Count)), shift);
                    Vector128<uint> carries = Vector128.ShiftRightLogical(Vector128.LoadUnsafe(ref start, (nuint)(offset - (Vector128<uint>.Count + 1))), back);
        ...
        public static void RightShiftSelf(Span<uint> bits, int shift, out uint carry)
        {
            ...
            if (Vector128.IsHardwareAccelerated)
            {
                ...
                {
                    Vector256<uint> current = Vector256.ShiftRightLogical(Vector256.LoadUnsafe(ref start, (nuint)offset), shift);
                    Vector256<uint> carries = Vector256.ShiftLeft(Vector256.LoadUnsafe(ref start, (nuint)(offset + 1)), back);
                ...
                {
                    Vector128<uint> current = Vector128.ShiftRightLogical(Vector128.LoadUnsafe(ref start, (nuint)offset), shift);
                    Vector128<uint> carries = Vector128.ShiftLeft(Vector128.LoadUnsafe(ref start, (nuint)(offset + 1)), back);
