...
namespace Kzrnm.Numerics.Decimal9
{
    internal static partial class BigIntegerCalculator
    {
        ...
        public struct ArrayPool<T> where T : unmanaged
        {
            public static ArrayPool<T> Shared = default;
            public T[] Rent(int s)
            {
                return System.Buffers.ArrayPool<T>.Shared.Rent(s);
            }
            public void Return(T[] a)
            {
                System.Buffers.ArrayPool<T>.Shared.Return(a);
            }
        }
    }
}
