...
namespace Kzrnm.Numerics.Decimal9
{
    ...
    public struct BigIntegerDecimal9
        : IComparable,
          IComparable<BigIntegerDecimal9>,
          IEquatable<BigIntegerDecimal9>,
          ISpanFormattable,
          INumber<BigIntegerDecimal9>,
          ISignedNumber<BigIntegerDecimal9>
    {
        /*
...
";
        ...
        private static readonly BigIntegerDecimal9 s_bnMinInt = new BigIntegerDecimal9(-1, new uint[] { 147483648, 2 });
        private static readonly BigIntegerDecimal9 s_bnOneInt = new BigIntegerDecimal9(1);
        private static readonly BigIntegerDecimal9 s_bnZeroInt = new BigIntegerDecimal9(0);
        private static readonly BigIntegerDecimal9 s_bnMinusOneInt = new BigIntegerDecimal9(-1);

        public BigIntegerDecimal9(long value) : this(NumericsHelpers.Abs(value))
        {
        ...
        public BigIntegerDecimal9(ulong value)
        {
        ...
        internal BigIntegerDecimal9(int n, uint[]? rgu)
        {
        ...
        private BigIntegerDecimal9(ReadOnlySpan<uint> value, bool negative)
        {
        ...
        public static BigIntegerDecimal9 Zero { get { return s_bnZeroInt; } }

        public static BigIntegerDecimal9 One { get { return s_bnOneInt; } }

        public static BigIntegerDecimal9 MinusOne { get { return s_bnMinusOneInt; } }
        ...
        public static BigIntegerDecimal9 Parse(string value)
        {
            return Parse(value, NumberStyles.Integer);
        }

        public static BigIntegerDecimal9 Parse(string value, NumberStyles style)
        {
            return Parse(value, style, NumberFormatInfo.CurrentInfo);
        }

        public static BigIntegerDecimal9 Parse(string value, IFormatProvider? provider)
        {
            return Parse(value, NumberStyles.Integer, NumberFormatInfo.GetInstance(provider));
        }

        public static BigIntegerDecimal9 Parse(string value, NumberStyles style, IFormatProvider? provider)
        {
            ArgumentNullException.ThrowIfNull(value);
            return Parse(value.AsSpan(), style, NumberFormatInfo.GetInstance(provider));
        }

        public static bool TryParse([NotNullWhen(true)] string? value, out BigIntegerDecimal9 result)
        {
            return TryParse(value, NumberStyles.Integer, NumberFormatInfo.CurrentInfo, out result);
        }

        public static bool TryParse([NotNullWhen(true)] string? value, NumberStyles style, IFormatProvider? provider, out BigIntegerDecimal9 result)
        {
            return TryParse(value.AsSpan(), style, NumberFormatInfo.GetInstance(provider), out result);
        }

        public static BigIntegerDecimal9 Parse(ReadOnlySpan<char> value, NumberStyles style = NumberStyles.Integer, IFormatProvider? provider = null)
        {
            if (!TryParse(value, style, provider, out BigIntegerDecimal9 result))
                throw new FormatException();
            return result;
        }

        public static bool TryParse(ReadOnlySpan<char> value, out BigIntegerDecimal9 result)
        {
            return TryParse(value, NumberStyles.Integer, NumberFormatInfo.CurrentInfo, out result);
        }

        public static bool TryParse(ReadOnlySpan<char> value, NumberStyles style, IFormatProvider? provider, out BigIntegerDecimal9 result)
        {
            bool negative = false;
            if (value.Length == 0)
            {
            ...
            result = new BigIntegerDecimal9(digits, negative);
            return true;
        }

        public static int Compare(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
            return left.CompareTo(right);
        }

        public static BigIntegerDecimal9 Abs(BigIntegerDecimal9 value)
        {
            return (value >= Zero) ? value : -value;
        }

        public static BigIntegerDecimal9 Add(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
            return left + right;
        }

        public static BigIntegerDecimal9 Subtract(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
            return left - right;
        }

        public static BigIntegerDecimal9 Multiply(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
            return left * right;
        }

        public static BigIntegerDecimal9 Divide(BigIntegerDecimal9 dividend, BigIntegerDecimal9 divisor)
        {
            return dividend / divisor;
        }

        public static BigIntegerDecimal9 Remainder(BigIntegerDecimal9 dividend, BigIntegerDecimal9 divisor)
        {
            return dividend % divisor;
        }

        public static BigIntegerDecimal9 DivRem(BigIntegerDecimal9 dividend, BigIntegerDecimal9 divisor, out BigIntegerDecimal9 remainder)
        {
            ...
            if (trivialDivisor)
            {
                ...
                try
                {
                    ...
                    return new BigIntegerDecimal9(quotient, (dividend._sign < 0) ^ (divisor._sign < 0));
                }
                finally
                {
            ...
            else
            {
                ...
                remainder = new BigIntegerDecimal9(rest, dividend._sign < 0);
                var result = new BigIntegerDecimal9(quotient, (dividend._sign < 0) ^ (divisor._sign < 0));
        ...
        public static BigIntegerDecimal9 Negate(BigIntegerDecimal9 value)
        {
            return -value;
        }
        ...
        public static BigIntegerDecimal9 Max(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
        ...
        public static BigIntegerDecimal9 Min(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
            if (left.CompareTo(right) <= 0)
                return left;
            return right;
        ...
        public override bool Equals([NotNullWhen(true)] object? obj)
        {
            ...
            return obj is BigIntegerDecimal9 other && Equals(other);
        }

        public bool Equals(BigIntegerDecimal9 other)
        {
            AssertValid();
            other.AssertValid();
        ...
        public int CompareTo(BigIntegerDecimal9 other)
        {
            AssertValid();
            other.AssertValid();
        ...
        public int CompareTo(object? obj)
        {
            if (obj == null)
                return 1;
            if (obj is BigIntegerDecimal9 bigInt)
        ...
        private static BigIntegerDecimal9 Add(ReadOnlySpan<uint> leftBits, int leftSign, ReadOnlySpan<uint> rightBits, int rightSign)
        {
            ...
            if (trivialLeft)
            {
                ...
                result = new BigIntegerDecimal9(bits, leftSign < 0);
            }
        ...
        public static BigIntegerDecimal9 operator -(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
            left.AssertValid();
            right.AssertValid();
        ...
        private static BigIntegerDecimal9 Subtract(ReadOnlySpan<uint> leftBits, int leftSign, ReadOnlySpan<uint> rightBits, int rightSign)
        {
            bool trivialLeft = leftBits.IsEmpty;
            bool trivialRight = rightBits.IsEmpty;
        ...
        public static explicit operator byte(BigIntegerDecimal9 value)
        {
        ...
        public static explicit operator char(BigIntegerDecimal9 value)
        {
            return checked((char)((int)value));
        }

        public static explicit operator short(BigIntegerDecimal9 value)
        {
            return checked((short)((int)value));
        }

        public static explicit operator int(BigIntegerDecimal9 value)
        {
            value.AssertValid();
            checked
            {
        ...
        public static explicit operator long(BigIntegerDecimal9 value)
        {
            value.AssertValid();
            if (value._dig == null)
            {
        ...
        public static explicit operator Int128(BigIntegerDecimal9 value)
        {
            value.AssertValid();
        ...
        public static explicit operator sbyte(BigIntegerDecimal9 value)
        {
            return checked((sbyte)((int)value));
        }


        public static explicit operator ushort(BigIntegerDecimal9 value)
        {
            return checked((ushort)((int)value));
        }

        public static explicit operator uint(BigIntegerDecimal9 value)
        {
            value.AssertValid();
            if (value._dig == null)
            {
        ...
        public static explicit operator ulong(BigIntegerDecimal9 value)
        {
            value.AssertValid();
            if (value._dig == null)
            {
        ...
        public static explicit operator UInt128(BigIntegerDecimal9 value)
        {
            value.AssertValid();
        ...
        public static implicit operator BigIntegerDecimal9(byte value)
        {
            return new BigIntegerDecimal9(value);
        }
        ...
        public static implicit operator BigIntegerDecimal9(char value)
        {
            return new BigIntegerDecimal9(value);
        }

        public static implicit operator BigIntegerDecimal9(short value)
        {
            return new BigIntegerDecimal9(value);
        }

        public static implicit operator BigIntegerDecimal9(int value)
        {
            return new BigIntegerDecimal9(value);
        }

        public static implicit operator BigIntegerDecimal9(long value)
        {
            return new BigIntegerDecimal9(value);
        }
        ...
        /// <param name="value">The value to convert.</param>
        /// <returns><paramref name="value" /> converted to a big integer.</returns>
        public static implicit operator BigIntegerDecimal9(Int128 value)
        {
            if (Int128.IsNegative(value))
            {
                if (value == Int128.MinValue)
                    return -(BigIntegerDecimal9)((UInt128)Int128.MaxValue + 1);
                return -(BigIntegerDecimal9)(UInt128)(-Int128.Abs(value));
            }
            return (BigIntegerDecimal9)(UInt128)value;
        }

        public static implicit operator BigIntegerDecimal9(sbyte value)
        {
            return new BigIntegerDecimal9(value);
        }

        public static implicit operator BigIntegerDecimal9(ushort value)
        {
            return new BigIntegerDecimal9(value);
        }

        public static implicit operator BigIntegerDecimal9(uint value)
        {
            return new BigIntegerDecimal9(value);
        }

        public static implicit operator BigIntegerDecimal9(ulong value)
        {
            return new BigIntegerDecimal9(value);
        }
        ...
        /// <param name="value">The value to convert.</param>
        /// <returns><paramref name="value" /> converted to a big integer.</returns>
        public static implicit operator BigIntegerDecimal9(UInt128 value)
        {
            ...
            return new BigIntegerDecimal9(stackalloc uint[3] { (uint)rem0, (uint)rem1, rem2 }, false);
        }

        public static BigIntegerDecimal9 operator -(BigIntegerDecimal9 value)
        {
            value.AssertValid();
            return new BigIntegerDecimal9(-value._sign, value._dig);
        }
        ...
        private static BigIntegerDecimal9 Multiply(ReadOnlySpan<uint> left, int leftSign, ReadOnlySpan<uint> right, int rightSign)
        {
            ...
            if (trivialLeft)
            {
                ...
                result = new BigIntegerDecimal9(bits, (leftSign < 0) ^ (rightSign < 0));
            }
            else if (trivialRight)
            {
        ...
        public static BigIntegerDecimal9 operator /(BigIntegerDecimal9 dividend, BigIntegerDecimal9 divisor)
        {
            dividend.AssertValid();
            divisor.AssertValid();
        ...
        public static BigIntegerDecimal9 operator %(BigIntegerDecimal9 dividend, BigIntegerDecimal9 divisor)
        {
            ...
            var result = new BigIntegerDecimal9(bits, dividend._sign < 0);
        ...
        public static bool operator <(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
        ...
        public static bool operator <(BigIntegerDecimal9 left, long right)
        {
            return left.CompareTo(right) < 0;
        }
        ...
        public static bool operator <(long left, BigIntegerDecimal9 right)
        {
        ...
        public static bool operator <(BigIntegerDecimal9 left, ulong right)
        {
            return left.CompareTo(right) < 0;
        }
        ...
        public static bool operator <(ulong left, BigIntegerDecimal9 right)
        {
            return right.CompareTo(left) > 0;
        }
        ...
        static BigIntegerDecimal9 IAdditiveIdentity<BigIntegerDecimal9, BigIntegerDecimal9>.AdditiveIdentity => Zero;
        //
        // IBinaryInteger
        //

        /// <inheritdoc cref="IBinaryInteger{TSelf}.DivRem(TSelf, TSelf)" />
        public static (BigIntegerDecimal9 Quotient, BigIntegerDecimal9 Remainder) DivRem(BigIntegerDecimal9 left, BigIntegerDecimal9 right)
        {
            BigIntegerDecimal9 quotient = DivRem(left, right, out BigIntegerDecimal9 remainder);
        ...
        static BigIntegerDecimal9 IMultiplicativeIdentity<BigIntegerDecimal9, BigIntegerDecimal9>.MultiplicativeIdentity => One;
        //
        // INumber
        //

        /// <inheritdoc cref="INumber{TSelf}.Clamp(TSelf, TSelf, TSelf)" />
        public static BigIntegerDecimal9 Clamp(BigIntegerDecimal9 value, BigIntegerDecimal9 min, BigIntegerDecimal9 max)
        {
            value.AssertValid();
        ...
        public static BigIntegerDecimal9 CopySign(BigIntegerDecimal9 value, BigIntegerDecimal9 sign)
        {
            value.AssertValid();
            sign.AssertValid();
        ...
        static BigIntegerDecimal9 INumber<BigIntegerDecimal9>.MaxNumber(BigIntegerDecimal9 x, BigIntegerDecimal9 y) => Max(x, y);

        /// <inheritdoc cref="INumber{TSelf}.MinNumber(TSelf, TSelf)" />
        static BigIntegerDecimal9 INumber<BigIntegerDecimal9>.MinNumber(BigIntegerDecimal9 x, BigIntegerDecimal9 y) => Min(x, y);

        /// <inheritdoc cref="INumber{TSelf}.Sign(TSelf)" />
        static int INumber<BigIntegerDecimal9>.Sign(BigIntegerDecimal9 value)
        {
            value.AssertValid();
        ...
        static int INumberBase<BigIntegerDecimal9>.Radix => 10;

        /// <inheritdoc cref="INumberBase{TSelf}.CreateChecked{TOther}(TOther)" />
        [MethodImpl(256)]
        public static BigIntegerDecimal9 CreateChecked<TOther>(TOther value)
            where TOther : INumberBase<TOther>
        {
            BigIntegerDecimal9 result;

            if (typeof(TOther) == typeof(BigIntegerDecimal9))
            {
                result = (BigIntegerDecimal9)(object)value;
            }
        ...
        [MethodImpl(256)]
        public static BigIntegerDecimal9 CreateSaturating<TOther>(TOther value)
            where TOther : INumberBase<TOther>
        {
            BigIntegerDecimal9 result;
        ...
        [MethodImpl(256)]
        public static BigIntegerDecimal9 CreateTruncating<TOther>(TOther value)
            where TOther : INumberBase<TOther>
        {
            BigIntegerDecimal9 result;
        ...
        static bool INumberBase<BigIntegerDecimal9>.IsCanonical(BigIntegerDecimal9 value) => true;

        /// <inheritdoc cref="INumberBase{TSelf}.IsComplexNumber(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsComplexNumber(BigIntegerDecimal9 value) => false;

        /// <inheritdoc cref="INumberBase{TSelf}.IsEvenInteger(TSelf)" />
        public static bool IsEvenInteger(BigIntegerDecimal9 value)
        {
            value.AssertValid();
        ...
        static bool INumberBase<BigIntegerDecimal9>.IsFinite(BigIntegerDecimal9 value) => true;

        /// <inheritdoc cref="INumberBase{TSelf}.IsImaginaryNumber(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsImaginaryNumber(BigIntegerDecimal9 value) => false;

        /// <inheritdoc cref="INumberBase{TSelf}.IsInfinity(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsInfinity(BigIntegerDecimal9 value) => false;

        /// <inheritdoc cref="INumberBase{TSelf}.IsInteger(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsInteger(BigIntegerDecimal9 value) => true;

        /// <inheritdoc cref="INumberBase{TSelf}.IsNaN(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsNaN(BigIntegerDecimal9 value) => false;

        /// <inheritdoc cref="INumberBase{TSelf}.IsNegative(TSelf)" />
        public static bool IsNegative(BigIntegerDecimal9 value)
        {
            value.AssertValid();
        ...
        static bool INumberBase<BigIntegerDecimal9>.IsNegativeInfinity(BigIntegerDecimal9 value) => false;

        /// <inheritdoc cref="INumberBase{TSelf}.IsNormal(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsNormal(BigIntegerDecimal9 value) => (value != 0);

        /// <inheritdoc cref="INumberBase{TSelf}.IsOddInteger(TSelf)" />
        public static bool IsOddInteger(BigIntegerDecimal9 value)
        {
            value.AssertValid();
        ...
        public static bool IsPositive(BigIntegerDecimal9 value)
        {
            value.AssertValid();
            return value._sign >= 0;
        }
        ...
        static bool INumberBase<BigIntegerDecimal9>.IsPositiveInfinity(BigIntegerDecimal9 value) => false;

        /// <inheritdoc cref="INumberBase{TSelf}.IsRealNumber(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsRealNumber(BigIntegerDecimal9 value) => true;

        /// <inheritdoc cref="INumberBase{TSelf}.IsSubnormal(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsSubnormal(BigIntegerDecimal9 value) => false;

        /// <inheritdoc cref="INumberBase{TSelf}.IsZero(TSelf)" />
        static bool INumberBase<BigIntegerDecimal9>.IsZero(BigIntegerDecimal9 value)
        {
            value.AssertValid();
            return value._sign == 0;
        }
        ...
        public static BigIntegerDecimal9 MaxMagnitude(BigIntegerDecimal9 x, BigIntegerDecimal9 y)
        {
            x.AssertValid();
            y.AssertValid();

            BigIntegerDecimal9 ax = Abs(x);
            BigIntegerDecimal9 ay = Abs(y);
        ...
        static BigIntegerDecimal9 INumberBase<BigIntegerDecimal9>.MaxMagnitudeNumber(BigIntegerDecimal9 x, BigIntegerDecimal9 y) => MaxMagnitude(x, y);

        /// <inheritdoc cref="INumberBase{TSelf}.MinMagnitude(TSelf, TSelf)" />
        public static BigIntegerDecimal9 MinMagnitude(BigIntegerDecimal9 x, BigIntegerDecimal9 y)
        {
            x.AssertValid();
            y.AssertValid();
        ...
        static BigIntegerDecimal9 INumberBase<BigIntegerDecimal9>.MinMagnitudeNumber(BigIntegerDecimal9 x, BigIntegerDecimal9 y) => MinMagnitude(x, y);

        /// <inheritdoc cref="INumberBase{TSelf}.TryConvertFromChecked{TOther}(TOther, out TSelf)" />
        [MethodImpl(256)]
        static bool INumberBase<BigIntegerDecimal9>.TryConvertFromChecked<TOther>(TOther value, out BigIntegerDecimal9 result) => TryConvertFromChecked(value, out result);

        [MethodImpl(256)]
        private static bool TryConvertFromChecked<TOther>(TOther value, out BigIntegerDecimal9 result)
            where TOther : INumberBase<TOther>
        {
        ...
        [MethodImpl(256)]
        static bool INumberBase<BigIntegerDecimal9>.TryConvertFromSaturating<TOther>(TOther value, out BigIntegerDecimal9 result) => TryConvertFromSaturating(value, out result);

        [MethodImpl(256)]
        private static bool TryConvertFromSaturating<TOther>(TOther value, out BigIntegerDecimal9 result)
            where TOther : INumberBase<TOther>
        {
            if (typeof(TOther) == typeof(byte))
            {
        ...
        [MethodImpl(256)]
        static bool INumberBase<BigIntegerDecimal9>.TryConvertFromTruncating<TOther>(TOther value, out BigIntegerDecimal9 result) => TryConvertFromTruncating(value, out result);

        [MethodImpl(256)]
        private static bool TryConvertFromTruncating<TOther>(TOther value, out BigIntegerDecimal9 result)
            where TOther : INumberBase<TOther>
        {
            if (typeof(TOther) == typeof(byte))
            {
        ...
        [MethodImpl(256)]
        static bool INumberBase<BigIntegerDecimal9>.TryConvertToChecked<TOther>(BigIntegerDecimal9 value, [MaybeNullWhen(false)] out TOther result)
        {
            if (typeof(TOther) == typeof(byte))
            {
        ...
        [MethodImpl(256)]
        static bool INumberBase<BigIntegerDecimal9>.TryConvertToSaturating<TOther>(BigIntegerDecimal9 value, [MaybeNullWhen(false)] out TOther result)
            => TryConvertToSaturatingImpl(value, out result);

        /// <inheritdoc cref="INumberBase{TSelf}.TryConvertToTruncating{TOther}(TSelf, out TOther)" />
        [MethodImpl(256)]
        static bool INumberBase<BigIntegerDecimal9>.TryConvertToTruncating<TOther>(BigIntegerDecimal9 value, [MaybeNullWhen(false)] out TOther result)
            => TryConvertToSaturatingImpl(value, out result);

        /// <inheritdoc cref="INumberBase{TSelf}.TryConvertToSaturating{TOther}(TSelf, out TOther)" />
        [MethodImpl(256)]
        static bool TryConvertToSaturatingImpl<TOther>(BigIntegerDecimal9 value, [MaybeNullWhen(false)] out TOther result)
        {
            if (typeof(TOther) == typeof(byte))
            {
                byte actualResult;
        ...
        public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, out BigIntegerDecimal9 result) => TryParse(s, NumberStyles.Integer, provider, out result);
        ...
        static BigIntegerDecimal9 ISignedNumber<BigIntegerDecimal9>.NegativeOne => MinusOne;
        //
        // ISpanParsable
        //

        /// <inheritdoc cref="ISpanParsable{TSelf}.Parse(ReadOnlySpan{char}, IFormatProvider?)" />
        public static BigIntegerDecimal9 Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Parse(s, NumberStyles.Integer, provider);

        /// <inheritdoc cref="ISpanParsable{TSelf}.TryParse(ReadOnlySpan{char}, IFormatProvider?, out TSelf)" />
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out BigIntegerDecimal9 result) => TryParse(s, NumberStyles.Integer, provider, out result);
    }
}
